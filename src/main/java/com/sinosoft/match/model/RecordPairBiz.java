...
public class RecordPairBiz {
	...
	private Record<MpiBizInfo> leftRecord;// 匹配方
	private Record<MpiBizIndex> rightRecord;// 被匹配方
	private Double weight;// 总匹配度
	private ComparisonVector comparisonVector;// 匹配详细

	public RecordPairBiz(Record<MpiBizInfo> leftRecord, Record<MpiBizIndex> rightRecord) {
		this.leftRecord = leftRecord;
		this.rightRecord = rightRecord;
	}

	public Record<MpiBizInfo> getLeftRecord() {
		return leftRecord;
	}

	public void setLeftRecord(Record<MpiBizInfo> leftRecord) {
		this.leftRecord = leftRecord;
	}
