...
public class MatchFieldCfg implements Serializable {
	...
	public String toString() {
		return "MatchFieldCfg [fieldCfgId=" + fieldCfgId + ", configId=" + configId
				+ ", propertyName=" + propertyName + ", agreeProb=" + agreeProb + ", disAgree="
				+ disAgree + ", matchThreshold=" + matchThreshold + ", matchFunction="
				+ matchFunction + ", weight=" + weight + ", cfgDesc=" + cfgDesc + "]";
	}	
