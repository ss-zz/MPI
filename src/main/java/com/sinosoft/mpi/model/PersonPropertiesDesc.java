...
public class PersonPropertiesDesc implements IBaseCode, Serializable {
	...
	public PersonPropertiesDesc() {
		super();
	}

	public PersonPropertiesDesc(String propertyName, String propertyDesc, String column) {
		super();
