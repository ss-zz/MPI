...
public class SysUser implements Serializable {
	...
	public String toString() {
		return "SysUser [userId=" + userId + ", sysRoleId=" + sysRoleId + ", userName=" + userName + ", password="
				+ password + ", name=" + name + ", email=" + email + ", state=" + state + ", createUserId="
				+ createUserId + ", createDate=" + createDate + ", updateUserId=" + updateUserId + ", updateDate="
				+ updateDate + "]";
	}
}
