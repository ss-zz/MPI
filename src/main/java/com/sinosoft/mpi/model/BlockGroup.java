...
public class BlockGroup implements Serializable {
	...
	public String getPropertyCnName() {
		return this.propertyCnName==null?CacheManager.getCodeName(PersonPropertiesDesc.class,this.propertyName):this.propertyCnName;
	}
	/**
	 * 字段中文名
	 */
	...
	public String toString() {
		return "BlockGroup [groupId=" + groupId + ", bolckId=" + bolckId + ", groupSign="
				+ groupSign + ", dbField=" + dbField + ", propertyName=" + propertyName
				+ ", funName=" + funName + "]";
	}
