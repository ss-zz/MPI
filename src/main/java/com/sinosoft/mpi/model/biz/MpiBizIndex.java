...
public class MpiBizIndex{
	...
	@PropertyDesc(name = "住院号", column = "BIZ_CLINICNO")
	private String bizInpatientno;
	@PropertyDesc(name = "住院就诊流水号", column = "BIZ_CLINIC_SERIALNO")
	...
	@PropertyDesc(name = "0-无效 1-有效", column = "STATE")
	...
	public MpiBizIndex(String id, String bizId, String bizPatientId, String bizSerialId, String bizInpatientno,
			...
			Date create_Date, String state, String remark) {
		super();
		this.id = id;
		this.bizId = bizId;
		this.bizPatientId = bizPatientId;
