...
/**
 * @author bysun 2012-3-26 需要人工干预的居民列表 table:MPI_MAN_OP_PERSON schema:
 */
public class ManOpPerson implements Serializable {
	...
	public String toString() {
		return "ManOpPerson [MAN_OP_ID=" + MAN_OP_ID + ", personId=" + FIELD_PK + ", MAN_OP_STATUS="
				+ MAN_OP_STATUS + ", MAN_OP_TIME=" + MAN_OP_TIME + "]";
	}
}
