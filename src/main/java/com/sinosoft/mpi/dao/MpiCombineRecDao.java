...
@Repository
public class MpiCombineRecDao extends IBaseDao<MpiCombineRec> {

	@Override
	public void add(final MpiCombineRec entity) {
		StringBuilder sql = new StringBuilder();
		sql.append("insert into MPI_COMBINE_REC( ").append("REGISTER_ORG_CODE,").append("MEDICALSERVICE_NO,")
				...
				.append("OTHER_OCCC_DESCR,").append("USUAL_TYPE_MARK,").append("NATIVE_CITY,").append("COMBINE_NO,")
				.append("SRC_LEVEL,")
