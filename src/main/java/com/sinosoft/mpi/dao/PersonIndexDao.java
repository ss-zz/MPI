...
@Repository("personIndexDao")
public class PersonIndexDao implements IPersonIndexDao {
	@Resource
	private JdbcTemplate jdbcTemplate;

	@Override
	public void add(final PersonIndex entity) {
		// 如果MPI数据库变化需要修改
		entity.setMPI_PK(IDUtil.getUUID());
		...
		jdbcTemplate.update(sql.toString(), new PreparedStatementSetter() {
			public void setValues(PreparedStatement ps) throws SQLException {
				...
				// ps.setDate(5, new java.sql.Date(entity.getBIRTH_DATE().getTime()));
				ps.setDate(5,
				...
				// ps.setDate(56, new java.sql.Date(entity.getREGISTER_DATE().getTime()));
				ps.setDate(56, entity.getREGISTER_DATE() == null ? null
				...
				ps.setDate(59, new java.sql.Date(entity.getSEND_TIME().getTime()));
				...
				ps.setDate(64, new java.sql.Date(entity.getCREATETIME().getTime()));
				ps.setDate(65,
				...
				ps.setString(171, entity.getMPI_PK());
				ps.setString(172, entity.getDOMAIN_LEVEL());
	...
	@Override
	public void deleteById(final PersonIndex entity) {
		String sql = " delete from mpi_person_index where mpi_pk = ?";
		jdbcTemplate.update(sql, new PreparedStatementSetter() {
			public void setValues(PreparedStatement ps) throws SQLException {
				ps.setString(1, entity.getMPI_PK());
			}
		});
	...
	@Override
	public void update(final PersonIndex entity) {
		if (entity == null || entity.getMPI_PK() == null) {
			return;
		}
		StringBuilder sql = new StringBuilder();
		...
		jdbcTemplate.update(sql.toString(), new PreparedStatementSetter() {
			public void setValues(PreparedStatement ps) throws SQLException {
				...
				ps.setString(171, entity.getPATIENT_ID());
				ps.setString(172, entity.getDRUG_ALLERGY_MARK());
				ps.setString(173, entity.getOP_HISTORY_MARK());
				ps.setString(174, entity.getTRAUMA_HISTORY_MARK());
				ps.setString(175, entity.getBLOOD_TRANSF_MARK());
				ps.setString(176, entity.getDISABILITY_MARK());
				ps.setString(177, entity.getGENETIC_DISEASE_HISTORY());
				ps.setString(178, entity.getEXHAUST_FACILITY_MARK());
				ps.setString(179, entity.getEXHAUST_FACILITY_TYPE_CODE());
				ps.setString(180, entity.getFUEL_TYPE_CODE());
				ps.setString(181, entity.getWATER_TYPE_CODE());
				ps.setString(182, entity.getTOILET_TYPE_CODE());
				ps.setString(183, entity.getLIVESTOCK_PEN_TYPE_CODE());
				ps.setString(184, entity.getOPERATION_HISTORY());
				ps.setString(185, entity.getASTHMA_MARK());
				ps.setString(186, entity.getHEDRT_DIS_MARK());
				ps.setString(187, entity.getCARDIOVASCULAR_CODE());
				ps.setString(188, entity.getEPILEPSY_MARK());
				ps.setString(189, entity.getCOAGULOPATHY_MARK());
				ps.setString(190, entity.getDIABETES_MARK());
				ps.setString(191, entity.getGLAUCOMA_MARK());
				ps.setString(192, entity.getDIALYSIS_MARK());
				ps.setString(193, entity.getORGAN_TRANS_MARK());
				ps.setString(194, entity.getORGAN_DEFECT_MARK());
				ps.setString(195, entity.getREMOVA_PRO_MARK());
				ps.setString(196, entity.getCARDIAC_PAC_MARK());
				ps.setString(197, entity.getORTHER_MEDICAL_ALERT());
				ps.setString(198, entity.getPSYCHIATRIC_MARK());

				ps.setString(199, entity.getMPI_PK());
			}
		});
	...
	public PersonIndex findById(PersonIndex entity) {
		...
		List<PersonIndex> datas = find(sql, new Object[] { entity.getMPI_PK() });
	...
	public List<PersonIndex> find(String sql) {
		List<PersonIndex> datas = find(sql, new Object[] {});
		return datas;
	}

	@Override
	public List<PersonIndex> find(String sql, Object[] args) {
		List<PersonIndex> datas = jdbcTemplate.query(sql, args, new RowMapper<PersonIndex>() {
			@Override
			public PersonIndex mapRow(ResultSet rs, int rowNum) throws SQLException {
	...
	public List<PersonIndex> findAll() {
		...
		List<PersonIndex> datas = find(sql);
		return datas;
	}
