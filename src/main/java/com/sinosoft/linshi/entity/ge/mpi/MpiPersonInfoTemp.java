...
public class MpiPersonInfoTemp implements Serializable {
    ...
    public String getFieldPkFk() {
        return fieldPkFk;
    }

    public void setFieldPkFk(String fieldPkFk) {
        this.fieldPkFk = fieldPkFk == null ? null : fieldPkFk.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        MpiPersonInfoTemp other = (MpiPersonInfoTemp) that;
        return (this.getFieldPk() == null ? other.getFieldPk() == null : this.getFieldPk().equals(other.getFieldPk()))
            ...
            && (this.getFieldPkFk() == null ? other.getFieldPkFk() == null : this.getFieldPkFk().equals(other.getFieldPkFk()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getFieldPkFk() == null) ? 0 : getFieldPkFk().hashCode());
