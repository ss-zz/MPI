...
public class MpiIndexOperate implements Serializable {
    ...
    public void setFormerMpiPk(String formerMpiPk) {
        this.formerMpiPk = formerMpiPk == null ? null : formerMpiPk.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        MpiIndexOperate other = (MpiIndexOperate) that;
        return (this.getPersonIdxLogId() == null ? other.getPersonIdxLogId() == null : this.getPersonIdxLogId().equals(other.getPersonIdxLogId()))
            ...
            && (this.getFormerMpiPk() == null ? other.getFormerMpiPk() == null : this.getFormerMpiPk().equals(other.getFormerMpiPk()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getFormerMpiPk() == null) ? 0 : getFormerMpiPk().hashCode());
        return result;
    }
}