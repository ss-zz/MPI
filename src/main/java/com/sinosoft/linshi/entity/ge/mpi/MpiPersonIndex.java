...
public class MpiPersonIndex implements Serializable {
    ...
    public Short getStateMpiRec() {
        return stateMpiRec;
    }

    public void setStateMpiRec(Short stateMpiRec) {
        this.stateMpiRec = stateMpiRec;
    }
    ...
    public boolean equals(Object that) {
        ...
        MpiPersonIndex other = (MpiPersonIndex) that;
        return (this.getMpiPk() == null ? other.getMpiPk() == null : this.getMpiPk().equals(other.getMpiPk()))
            ...
            && (this.getStateMpiRec() == null ? other.getStateMpiRec() == null : this.getStateMpiRec().equals(other.getStateMpiRec()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getStateMpiRec() == null) ? 0 : getStateMpiRec().hashCode());
