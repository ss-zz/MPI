...
public class MpiPersonInfo implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        MpiPersonInfo other = (MpiPersonInfo) that;
        return (this.getFieldPk() == null ? other.getFieldPk() == null : this.getFieldPk().equals(other.getFieldPk()))
            && (this.getRegisterOrgCode() == null ? other.getRegisterOrgCode() == null : this.getRegisterOrgCode().equals(other.getRegisterOrgCode()))
            && (this.getRegisterOrgName() == null ? other.getRegisterOrgName() == null : this.getRegisterOrgName().equals(other.getRegisterOrgName()))
            && (this.getMedicalserviceNo() == null ? other.getMedicalserviceNo() == null : this.getMedicalserviceNo().equals(other.getMedicalserviceNo()))
            ...
            && (this.getAdCd() == null ? other.getAdCd() == null : this.getAdCd().equals(other.getAdCd()))
            ...
            && (this.getLinkmanRelCd() == null ? other.getLinkmanRelCd() == null : this.getLinkmanRelCd().equals(other.getLinkmanRelCd()))
            && (this.getLmIdNoCd() == null ? other.getLmIdNoCd() == null : this.getLmIdNoCd().equals(other.getLmIdNoCd()))
            && (this.getLmIdNo() == null ? other.getLmIdNo() == null : this.getLmIdNo().equals(other.getLmIdNo()))
            ...
            && (this.getAboCd() == null ? other.getAboCd() == null : this.getAboCd().equals(other.getAboCd()))
            && (this.getRhCd() == null ? other.getRhCd() == null : this.getRhCd().equals(other.getRhCd()))
            && (this.getRhNegCd() == null ? other.getRhNegCd() == null : this.getRhNegCd().equals(other.getRhNegCd()))
            && (this.getCardEdBgCd() == null ? other.getCardEdBgCd() == null : this.getCardEdBgCd().equals(other.getCardEdBgCd()))
            && (this.getBirthPlace() == null ? other.getBirthPlace() == null : this.getBirthPlace().equals(other.getBirthPlace()))
            && (this.getWorkingUnitName() == null ? other.getWorkingUnitName() == null : this.getWorkingUnitName().equals(other.getWorkingUnitName()))
            && (this.getEmailAd() == null ? other.getEmailAd() == null : this.getEmailAd().equals(other.getEmailAd()))
            && (this.getVeteransMilitaryMark() == null ? other.getVeteransMilitaryMark() == null : this.getVeteransMilitaryMark().equals(other.getVeteransMilitaryMark()))
            && (this.getCardNo() == null ? other.getCardNo() == null : this.getCardNo().equals(other.getCardNo()))
            && (this.getCardCd() == null ? other.getCardCd() == null : this.getCardCd().equals(other.getCardCd()))
            && (this.getCardArea() == null ? other.getCardArea() == null : this.getCardArea().equals(other.getCardArea()))
            && (this.getPatientType() == null ? other.getPatientType() == null : this.getPatientType().equals(other.getPatientType()))
            && (this.getmPhoneNum() == null ? other.getmPhoneNum() == null : this.getmPhoneNum().equals(other.getmPhoneNum()))
            && (this.getWorkingUnitPost() == null ? other.getWorkingUnitPost() == null : this.getWorkingUnitPost().equals(other.getWorkingUnitPost()))
            && (this.getWorkingUnitAddr() == null ? other.getWorkingUnitAddr() == null : this.getWorkingUnitAddr().equals(other.getWorkingUnitAddr()))
            && (this.getLivingAddr() == null ? other.getLivingAddr() == null : this.getLivingAddr().equals(other.getLivingAddr()))
            && (this.getRprAddr() == null ? other.getRprAddr() == null : this.getRprAddr().equals(other.getRprAddr()))
            && (this.getRprPost() == null ? other.getRprPost() == null : this.getRprPost().equals(other.getRprPost()))
            && (this.getRprPhone() == null ? other.getRprPhone() == null : this.getRprPhone().equals(other.getRprPhone()))
            && (this.getLinkmanAddr() == null ? other.getLinkmanAddr() == null : this.getLinkmanAddr().equals(other.getLinkmanAddr()))
            && (this.getLinkmanPost() == null ? other.getLinkmanPost() == null : this.getLinkmanPost().equals(other.getLinkmanPost()))
            && (this.getLinkmanPhone() == null ? other.getLinkmanPhone() == null : this.getLinkmanPhone().equals(other.getLinkmanPhone()))
            && (this.getInsureType() == null ? other.getInsureType() == null : this.getInsureType().equals(other.getInsureType()))
            && (this.getMedicalTreatmentName() == null ? other.getMedicalTreatmentName() == null : this.getMedicalTreatmentName().equals(other.getMedicalTreatmentName()))
            && (this.getMedicalTreatmentCd() == null ? other.getMedicalTreatmentCd() == null : this.getMedicalTreatmentCd().equals(other.getMedicalTreatmentCd()))
            ...
            && (this.getRegisterPersonCode() == null ? other.getRegisterPersonCode() == null : this.getRegisterPersonCode().equals(other.getRegisterPersonCode()))
            && (this.getSendTime() == null ? other.getSendTime() == null : this.getSendTime().equals(other.getSendTime()))
            && (this.getSendOrgCode() == null ? other.getSendOrgCode() == null : this.getSendOrgCode().equals(other.getSendOrgCode()))
            && (this.getSendSystem() == null ? other.getSendSystem() == null : this.getSendSystem().equals(other.getSendSystem()))
            && (this.getProviderName() == null ? other.getProviderName() == null : this.getProviderName().equals(other.getProviderName()))
            && (this.getProviderOrgCode() == null ? other.getProviderOrgCode() == null : this.getProviderOrgCode().equals(other.getProviderOrgCode()))
            ...
            && (this.getGenderCs() == null ? other.getGenderCs() == null : this.getGenderCs().equals(other.getGenderCs()))
            && (this.getGenderCsn() == null ? other.getGenderCsn() == null : this.getGenderCsn().equals(other.getGenderCsn()))
            && (this.getGenderCsv() == null ? other.getGenderCsv() == null : this.getGenderCsv().equals(other.getGenderCsv()))
            && (this.getGenderDn() == null ? other.getGenderDn() == null : this.getGenderDn().equals(other.getGenderDn()))
            && (this.getCardMaritalStCs() == null ? other.getCardMaritalStCs() == null : this.getCardMaritalStCs().equals(other.getCardMaritalStCs()))
            && (this.getCardMaritalStCsn() == null ? other.getCardMaritalStCsn() == null : this.getCardMaritalStCsn().equals(other.getCardMaritalStCsn()))
            && (this.getCardMaritalStCsv() == null ? other.getCardMaritalStCsv() == null : this.getCardMaritalStCsv().equals(other.getCardMaritalStCsv()))
            && (this.getCardMaritalStDn() == null ? other.getCardMaritalStDn() == null : this.getCardMaritalStDn().equals(other.getCardMaritalStDn()))
            && (this.getIdNoCs() == null ? other.getIdNoCs() == null : this.getIdNoCs().equals(other.getIdNoCs()))
            && (this.getIdNoCsn() == null ? other.getIdNoCsn() == null : this.getIdNoCsn().equals(other.getIdNoCsn()))
            && (this.getIdNoCsv() == null ? other.getIdNoCsv() == null : this.getIdNoCsv().equals(other.getIdNoCsv()))
            && (this.getIdNoDn() == null ? other.getIdNoDn() == null : this.getIdNoDn().equals(other.getIdNoDn()))
            && (this.getMedicareCs() == null ? other.getMedicareCs() == null : this.getMedicareCs().equals(other.getMedicareCs()))
            && (this.getMedicareCsn() == null ? other.getMedicareCsn() == null : this.getMedicareCsn().equals(other.getMedicareCsn()))
            && (this.getMedicareCsv() == null ? other.getMedicareCsv() == null : this.getMedicareCsv().equals(other.getMedicareCsv()))
            && (this.getMedicareDn() == null ? other.getMedicareDn() == null : this.getMedicareDn().equals(other.getMedicareDn()))
            && (this.getNhCard() == null ? other.getNhCard() == null : this.getNhCard().equals(other.getNhCard()))
            && (this.getSscid() == null ? other.getSscid() == null : this.getSscid().equals(other.getSscid()))
            && (this.getCardOccuTypeCs() == null ? other.getCardOccuTypeCs() == null : this.getCardOccuTypeCs().equals(other.getCardOccuTypeCs()))
            && (this.getCardOccuTypeCsn() == null ? other.getCardOccuTypeCsn() == null : this.getCardOccuTypeCsn().equals(other.getCardOccuTypeCsn()))
            && (this.getCardOccuTypeCsv() == null ? other.getCardOccuTypeCsv() == null : this.getCardOccuTypeCsv().equals(other.getCardOccuTypeCsv()))
            && (this.getCardOccuTypeDn() == null ? other.getCardOccuTypeDn() == null : this.getCardOccuTypeDn().equals(other.getCardOccuTypeDn()))
            && (this.getCardNationCs() == null ? other.getCardNationCs() == null : this.getCardNationCs().equals(other.getCardNationCs()))
            && (this.getCardNationCsn() == null ? other.getCardNationCsn() == null : this.getCardNationCsn().equals(other.getCardNationCsn()))
            && (this.getCardNationCsv() == null ? other.getCardNationCsv() == null : this.getCardNationCsv().equals(other.getCardNationCsv()))
            && (this.getCardNationDn() == null ? other.getCardNationDn() == null : this.getCardNationDn().equals(other.getCardNationDn()))
            && (this.getNationalityCs() == null ? other.getNationalityCs() == null : this.getNationalityCs().equals(other.getNationalityCs()))
            && (this.getNationalityCsn() == null ? other.getNationalityCsn() == null : this.getNationalityCsn().equals(other.getNationalityCsn()))
            && (this.getNationalityCsv() == null ? other.getNationalityCsv() == null : this.getNationalityCsv().equals(other.getNationalityCsv()))
            && (this.getNationalityDn() == null ? other.getNationalityDn() == null : this.getNationalityDn().equals(other.getNationalityDn()))
            && (this.getArCs() == null ? other.getArCs() == null : this.getArCs().equals(other.getArCs()))
            && (this.getArCsn() == null ? other.getArCsn() == null : this.getArCsn().equals(other.getArCsn()))
            && (this.getArCsv() == null ? other.getArCsv() == null : this.getArCsv().equals(other.getArCsv()))
            && (this.getArDn() == null ? other.getArDn() == null : this.getArDn().equals(other.getArDn()))
            && (this.getAdCs() == null ? other.getAdCs() == null : this.getAdCs().equals(other.getAdCs()))
            && (this.getAdCsn() == null ? other.getAdCsn() == null : this.getAdCsn().equals(other.getAdCsn()))
            && (this.getAdCsv() == null ? other.getAdCsv() == null : this.getAdCsv().equals(other.getAdCsv()))
            && (this.getAdDn() == null ? other.getAdDn() == null : this.getAdDn().equals(other.getAdDn()))
            && (this.getTelTypeCs() == null ? other.getTelTypeCs() == null : this.getTelTypeCs().equals(other.getTelTypeCs()))
            && (this.getTelTypeCsn() == null ? other.getTelTypeCsn() == null : this.getTelTypeCsn().equals(other.getTelTypeCsn()))
            && (this.getTelTypeCsv() == null ? other.getTelTypeCsv() == null : this.getTelTypeCsv().equals(other.getTelTypeCsv()))
            && (this.getTelTypeDn() == null ? other.getTelTypeDn() == null : this.getTelTypeDn().equals(other.getTelTypeDn()))
            && (this.getLinkmanRelCs() == null ? other.getLinkmanRelCs() == null : this.getLinkmanRelCs().equals(other.getLinkmanRelCs()))
            && (this.getLinkmanRelCsn() == null ? other.getLinkmanRelCsn() == null : this.getLinkmanRelCsn().equals(other.getLinkmanRelCsn()))
            && (this.getLinkmanRelCsv() == null ? other.getLinkmanRelCsv() == null : this.getLinkmanRelCsv().equals(other.getLinkmanRelCsv()))
            && (this.getLinkmanRelDn() == null ? other.getLinkmanRelDn() == null : this.getLinkmanRelDn().equals(other.getLinkmanRelDn()))
            && (this.getLmIdNoCs() == null ? other.getLmIdNoCs() == null : this.getLmIdNoCs().equals(other.getLmIdNoCs()))
            && (this.getLmIdNoCsn() == null ? other.getLmIdNoCsn() == null : this.getLmIdNoCsn().equals(other.getLmIdNoCsn()))
            && (this.getLmIdNoCsv() == null ? other.getLmIdNoCsv() == null : this.getLmIdNoCsv().equals(other.getLmIdNoCsv()))
            && (this.getLmIdNoDn() == null ? other.getLmIdNoDn() == null : this.getLmIdNoDn().equals(other.getLmIdNoDn()))
            && (this.getAboCs() == null ? other.getAboCs() == null : this.getAboCs().equals(other.getAboCs()))
            && (this.getAboCsn() == null ? other.getAboCsn() == null : this.getAboCsn().equals(other.getAboCsn()))
            && (this.getAboCsv() == null ? other.getAboCsv() == null : this.getAboCsv().equals(other.getAboCsv()))
            && (this.getAboDn() == null ? other.getAboDn() == null : this.getAboDn().equals(other.getAboDn()))
            && (this.getRhCs() == null ? other.getRhCs() == null : this.getRhCs().equals(other.getRhCs()))
            && (this.getRhCsn() == null ? other.getRhCsn() == null : this.getRhCsn().equals(other.getRhCsn()))
            && (this.getRhCsv() == null ? other.getRhCsv() == null : this.getRhCsv().equals(other.getRhCsv()))
            && (this.getRhDn() == null ? other.getRhDn() == null : this.getRhDn().equals(other.getRhDn()))
            && (this.getCardEdBgCs() == null ? other.getCardEdBgCs() == null : this.getCardEdBgCs().equals(other.getCardEdBgCs()))
            && (this.getCardEdBgCsn() == null ? other.getCardEdBgCsn() == null : this.getCardEdBgCsn().equals(other.getCardEdBgCsn()))
            && (this.getCardEdBgCsv() == null ? other.getCardEdBgCsv() == null : this.getCardEdBgCsv().equals(other.getCardEdBgCsv()))
            && (this.getCardEdBgDn() == null ? other.getCardEdBgDn() == null : this.getCardEdBgDn().equals(other.getCardEdBgDn()))
            && (this.getBirthPlaceCs() == null ? other.getBirthPlaceCs() == null : this.getBirthPlaceCs().equals(other.getBirthPlaceCs()))
            && (this.getBirthPlaceCsn() == null ? other.getBirthPlaceCsn() == null : this.getBirthPlaceCsn().equals(other.getBirthPlaceCsn()))
            && (this.getBirthPlaceCsv() == null ? other.getBirthPlaceCsv() == null : this.getBirthPlaceCsv().equals(other.getBirthPlaceCsv()))
            && (this.getBirthPlaceDn() == null ? other.getBirthPlaceDn() == null : this.getBirthPlaceDn().equals(other.getBirthPlaceDn()))
            && (this.getNativeProvince() == null ? other.getNativeProvince() == null : this.getNativeProvince().equals(other.getNativeProvince()))
            && (this.getNativeProvinceCs() == null ? other.getNativeProvinceCs() == null : this.getNativeProvinceCs().equals(other.getNativeProvinceCs()))
            && (this.getNativeProvinceCsn() == null ? other.getNativeProvinceCsn() == null : this.getNativeProvinceCsn().equals(other.getNativeProvinceCsn()))
            && (this.getNativeProvinceCsv() == null ? other.getNativeProvinceCsv() == null : this.getNativeProvinceCsv().equals(other.getNativeProvinceCsv()))
            && (this.getNativeProvinceDn() == null ? other.getNativeProvinceDn() == null : this.getNativeProvinceDn().equals(other.getNativeProvinceDn()))
            && (this.getNativeCity() == null ? other.getNativeCity() == null : this.getNativeCity().equals(other.getNativeCity()))
            && (this.getNativeCityCs() == null ? other.getNativeCityCs() == null : this.getNativeCityCs().equals(other.getNativeCityCs()))
            && (this.getNativeCityCsn() == null ? other.getNativeCityCsn() == null : this.getNativeCityCsn().equals(other.getNativeCityCsn()))
            && (this.getNativeCityCsv() == null ? other.getNativeCityCsv() == null : this.getNativeCityCsv().equals(other.getNativeCityCsv()))
            && (this.getNativeCityDn() == null ? other.getNativeCityDn() == null : this.getNativeCityDn().equals(other.getNativeCityDn()))
            && (this.getVeteransMilitaryValue() == null ? other.getVeteransMilitaryValue() == null : this.getVeteransMilitaryValue().equals(other.getVeteransMilitaryValue()))
            && (this.getVeteransMilitaryMarkCs() == null ? other.getVeteransMilitaryMarkCs() == null : this.getVeteransMilitaryMarkCs().equals(other.getVeteransMilitaryMarkCs()))
            && (this.getVeteransMilitaryMarkCsn() == null ? other.getVeteransMilitaryMarkCsn() == null : this.getVeteransMilitaryMarkCsn().equals(other.getVeteransMilitaryMarkCsn()))
            && (this.getVeteransMilitaryMarkCsv() == null ? other.getVeteransMilitaryMarkCsv() == null : this.getVeteransMilitaryMarkCsv().equals(other.getVeteransMilitaryMarkCsv()))
            && (this.getCardCs() == null ? other.getCardCs() == null : this.getCardCs().equals(other.getCardCs()))
            && (this.getCardCsn() == null ? other.getCardCsn() == null : this.getCardCsn().equals(other.getCardCsn()))
            && (this.getCardCsv() == null ? other.getCardCsv() == null : this.getCardCsv().equals(other.getCardCsv()))
            && (this.getCardDn() == null ? other.getCardDn() == null : this.getCardDn().equals(other.getCardDn()))
            && (this.getCardAreaCs() == null ? other.getCardAreaCs() == null : this.getCardAreaCs().equals(other.getCardAreaCs()))
            && (this.getCardAreaCsn() == null ? other.getCardAreaCsn() == null : this.getCardAreaCsn().equals(other.getCardAreaCsn()))
            && (this.getCardAreaCsv() == null ? other.getCardAreaCsv() == null : this.getCardAreaCsv().equals(other.getCardAreaCsv()))
            && (this.getCardAreaDn() == null ? other.getCardAreaDn() == null : this.getCardAreaDn().equals(other.getCardAreaDn()))
            && (this.getPatientTypeValue() == null ? other.getPatientTypeValue() == null : this.getPatientTypeValue().equals(other.getPatientTypeValue()))
            && (this.getPatientTypeCs() == null ? other.getPatientTypeCs() == null : this.getPatientTypeCs().equals(other.getPatientTypeCs()))
            && (this.getPatientTypeCsn() == null ? other.getPatientTypeCsn() == null : this.getPatientTypeCsn().equals(other.getPatientTypeCsn()))
            && (this.getPatientTypeCsv() == null ? other.getPatientTypeCsv() == null : this.getPatientTypeCsv().equals(other.getPatientTypeCsv()))
            && (this.getPatientTypeDescr() == null ? other.getPatientTypeDescr() == null : this.getPatientTypeDescr().equals(other.getPatientTypeDescr()))
            && (this.getWorkingTelNo() == null ? other.getWorkingTelNo() == null : this.getWorkingTelNo().equals(other.getWorkingTelNo()))
            && (this.getMedicalTreatmentCs() == null ? other.getMedicalTreatmentCs() == null : this.getMedicalTreatmentCs().equals(other.getMedicalTreatmentCs()))
            && (this.getMedicalTreatmentCsn() == null ? other.getMedicalTreatmentCsn() == null : this.getMedicalTreatmentCsn().equals(other.getMedicalTreatmentCsn()))
            && (this.getMedicalTreatmentCsv() == null ? other.getMedicalTreatmentCsv() == null : this.getMedicalTreatmentCsv().equals(other.getMedicalTreatmentCsv()))
            && (this.getVersionNum() == null ? other.getVersionNum() == null : this.getVersionNum().equals(other.getVersionNum()))
            && (this.getResponsDocCode() == null ? other.getResponsDocCode() == null : this.getResponsDocCode().equals(other.getResponsDocCode()))
            && (this.getResponsDocName() == null ? other.getResponsDocName() == null : this.getResponsDocName().equals(other.getResponsDocName()))
            && (this.getOtherOcccDescr() == null ? other.getOtherOcccDescr() == null : this.getOtherOcccDescr().equals(other.getOtherOcccDescr()))
            && (this.getUsualTypeMark() == null ? other.getUsualTypeMark() == null : this.getUsualTypeMark().equals(other.getUsualTypeMark()))
            && (this.getSrcLevel() == null ? other.getSrcLevel() == null : this.getSrcLevel().equals(other.getSrcLevel()))
            && (this.getRelationPk() == null ? other.getRelationPk() == null : this.getRelationPk().equals(other.getRelationPk()))
            ...
            && (this.getBackups() == null ? other.getBackups() == null : this.getBackups().equals(other.getBackups()))
            ...
            && (this.getDrugAllergyMark() == null ? other.getDrugAllergyMark() == null : this.getDrugAllergyMark().equals(other.getDrugAllergyMark()))
            && (this.getOpHistoryMark() == null ? other.getOpHistoryMark() == null : this.getOpHistoryMark().equals(other.getOpHistoryMark()))
            && (this.getTraumaHistoryMark() == null ? other.getTraumaHistoryMark() == null : this.getTraumaHistoryMark().equals(other.getTraumaHistoryMark()))
            && (this.getBloodTransfMark() == null ? other.getBloodTransfMark() == null : this.getBloodTransfMark().equals(other.getBloodTransfMark()))
            && (this.getDisabilityMark() == null ? other.getDisabilityMark() == null : this.getDisabilityMark().equals(other.getDisabilityMark()))
            && (this.getGeneticDiseaseHistory() == null ? other.getGeneticDiseaseHistory() == null : this.getGeneticDiseaseHistory().equals(other.getGeneticDiseaseHistory()))
            && (this.getExhaustFacilityMark() == null ? other.getExhaustFacilityMark() == null : this.getExhaustFacilityMark().equals(other.getExhaustFacilityMark()))
            && (this.getExhaustFacilityTypeCode() == null ? other.getExhaustFacilityTypeCode() == null : this.getExhaustFacilityTypeCode().equals(other.getExhaustFacilityTypeCode()))
            && (this.getFuelTypeCode() == null ? other.getFuelTypeCode() == null : this.getFuelTypeCode().equals(other.getFuelTypeCode()))
            && (this.getWaterTypeCode() == null ? other.getWaterTypeCode() == null : this.getWaterTypeCode().equals(other.getWaterTypeCode()))
            && (this.getToiletTypeCode() == null ? other.getToiletTypeCode() == null : this.getToiletTypeCode().equals(other.getToiletTypeCode()))
            && (this.getLivestockPenTypeCode() == null ? other.getLivestockPenTypeCode() == null : this.getLivestockPenTypeCode().equals(other.getLivestockPenTypeCode()))
            && (this.getOperationHistory() == null ? other.getOperationHistory() == null : this.getOperationHistory().equals(other.getOperationHistory()))
            && (this.getAsthmaMark() == null ? other.getAsthmaMark() == null : this.getAsthmaMark().equals(other.getAsthmaMark()))
            && (this.getHedrtDisMark() == null ? other.getHedrtDisMark() == null : this.getHedrtDisMark().equals(other.getHedrtDisMark()))
            && (this.getCardiovascularCode() == null ? other.getCardiovascularCode() == null : this.getCardiovascularCode().equals(other.getCardiovascularCode()))
            && (this.getEpilepsyMark() == null ? other.getEpilepsyMark() == null : this.getEpilepsyMark().equals(other.getEpilepsyMark()))
            && (this.getCoagulopathyMark() == null ? other.getCoagulopathyMark() == null : this.getCoagulopathyMark().equals(other.getCoagulopathyMark()))
            && (this.getDiabetesMark() == null ? other.getDiabetesMark() == null : this.getDiabetesMark().equals(other.getDiabetesMark()))
            && (this.getGlaucomaMark() == null ? other.getGlaucomaMark() == null : this.getGlaucomaMark().equals(other.getGlaucomaMark()))
            && (this.getDialysisMark() == null ? other.getDialysisMark() == null : this.getDialysisMark().equals(other.getDialysisMark()))
            && (this.getOrganTransMark() == null ? other.getOrganTransMark() == null : this.getOrganTransMark().equals(other.getOrganTransMark()))
            && (this.getOrganDefectMark() == null ? other.getOrganDefectMark() == null : this.getOrganDefectMark().equals(other.getOrganDefectMark()))
            && (this.getRemovaProMark() == null ? other.getRemovaProMark() == null : this.getRemovaProMark().equals(other.getRemovaProMark()))
            && (this.getCardiacPacMark() == null ? other.getCardiacPacMark() == null : this.getCardiacPacMark().equals(other.getCardiacPacMark()))
            && (this.getOrtherMedicalAlert() == null ? other.getOrtherMedicalAlert() == null : this.getOrtherMedicalAlert().equals(other.getOrtherMedicalAlert()))
            && (this.getPsychiatricMark() == null ? other.getPsychiatricMark() == null : this.getPsychiatricMark().equals(other.getPsychiatricMark()))
            && (this.getFlag() == null ? other.getFlag() == null : this.getFlag().equals(other.getFlag()))
            && (this.getFlagGa() == null ? other.getFlagGa() == null : this.getFlagGa().equals(other.getFlagGa()))
            && (this.getDtUpdateGa() == null ? other.getDtUpdateGa() == null : this.getDtUpdateGa().equals(other.getDtUpdateGa()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getRegisterOrgCode() == null) ? 0 : getRegisterOrgCode().hashCode());
        result = prime * result + ((getRegisterOrgName() == null) ? 0 : getRegisterOrgName().hashCode());
        result = prime * result + ((getMedicalserviceNo() == null) ? 0 : getMedicalserviceNo().hashCode());
        ...
        result = prime * result + ((getAdCd() == null) ? 0 : getAdCd().hashCode());
        ...
        result = prime * result + ((getLinkmanRelCd() == null) ? 0 : getLinkmanRelCd().hashCode());
        result = prime * result + ((getLmIdNoCd() == null) ? 0 : getLmIdNoCd().hashCode());
        result = prime * result + ((getLmIdNo() == null) ? 0 : getLmIdNo().hashCode());
        result = prime * result + ((getHrId() == null) ? 0 : getHrId().hashCode());
        result = prime * result + ((getPostCd() == null) ? 0 : getPostCd().hashCode());
        result = prime * result + ((getAboCd() == null) ? 0 : getAboCd().hashCode());
        result = prime * result + ((getRhCd() == null) ? 0 : getRhCd().hashCode());
        result = prime * result + ((getRhNegCd() == null) ? 0 : getRhNegCd().hashCode());
        result = prime * result + ((getCardEdBgCd() == null) ? 0 : getCardEdBgCd().hashCode());
        result = prime * result + ((getBirthPlace() == null) ? 0 : getBirthPlace().hashCode());
        result = prime * result + ((getWorkingUnitName() == null) ? 0 : getWorkingUnitName().hashCode());
        result = prime * result + ((getEmailAd() == null) ? 0 : getEmailAd().hashCode());
        result = prime * result + ((getVeteransMilitaryMark() == null) ? 0 : getVeteransMilitaryMark().hashCode());
        result = prime * result + ((getCardNo() == null) ? 0 : getCardNo().hashCode());
        result = prime * result + ((getCardCd() == null) ? 0 : getCardCd().hashCode());
        result = prime * result + ((getCardArea() == null) ? 0 : getCardArea().hashCode());
        result = prime * result + ((getPatientType() == null) ? 0 : getPatientType().hashCode());
        result = prime * result + ((getmPhoneNum() == null) ? 0 : getmPhoneNum().hashCode());
        result = prime * result + ((getWorkingUnitPost() == null) ? 0 : getWorkingUnitPost().hashCode());
        result = prime * result + ((getWorkingUnitAddr() == null) ? 0 : getWorkingUnitAddr().hashCode());
        result = prime * result + ((getLivingAddr() == null) ? 0 : getLivingAddr().hashCode());
        result = prime * result + ((getRprAddr() == null) ? 0 : getRprAddr().hashCode());
        result = prime * result + ((getRprPost() == null) ? 0 : getRprPost().hashCode());
        result = prime * result + ((getRprPhone() == null) ? 0 : getRprPhone().hashCode());
        result = prime * result + ((getLinkmanAddr() == null) ? 0 : getLinkmanAddr().hashCode());
        result = prime * result + ((getLinkmanPost() == null) ? 0 : getLinkmanPost().hashCode());
        result = prime * result + ((getLinkmanPhone() == null) ? 0 : getLinkmanPhone().hashCode());
        result = prime * result + ((getInsureType() == null) ? 0 : getInsureType().hashCode());
        result = prime * result + ((getMedicalTreatmentName() == null) ? 0 : getMedicalTreatmentName().hashCode());
        result = prime * result + ((getMedicalTreatmentCd() == null) ? 0 : getMedicalTreatmentCd().hashCode());
        ...
        result = prime * result + ((getRegisterPersonCode() == null) ? 0 : getRegisterPersonCode().hashCode());
        result = prime * result + ((getSendTime() == null) ? 0 : getSendTime().hashCode());
        result = prime * result + ((getSendOrgCode() == null) ? 0 : getSendOrgCode().hashCode());
        result = prime * result + ((getSendSystem() == null) ? 0 : getSendSystem().hashCode());
        result = prime * result + ((getProviderName() == null) ? 0 : getProviderName().hashCode());
        result = prime * result + ((getProviderOrgCode() == null) ? 0 : getProviderOrgCode().hashCode());
        result = prime * result + ((getCreatetime() == null) ? 0 : getCreatetime().hashCode());
        result = prime * result + ((getLastuptime() == null) ? 0 : getLastuptime().hashCode());
        result = prime * result + ((getState() == null) ? 0 : getState().hashCode());
        result = prime * result + ((getGenderCs() == null) ? 0 : getGenderCs().hashCode());
        result = prime * result + ((getGenderCsn() == null) ? 0 : getGenderCsn().hashCode());
        result = prime * result + ((getGenderCsv() == null) ? 0 : getGenderCsv().hashCode());
        result = prime * result + ((getGenderDn() == null) ? 0 : getGenderDn().hashCode());
        result = prime * result + ((getCardMaritalStCs() == null) ? 0 : getCardMaritalStCs().hashCode());
        result = prime * result + ((getCardMaritalStCsn() == null) ? 0 : getCardMaritalStCsn().hashCode());
        result = prime * result + ((getCardMaritalStCsv() == null) ? 0 : getCardMaritalStCsv().hashCode());
        result = prime * result + ((getCardMaritalStDn() == null) ? 0 : getCardMaritalStDn().hashCode());
        result = prime * result + ((getIdNoCs() == null) ? 0 : getIdNoCs().hashCode());
        result = prime * result + ((getIdNoCsn() == null) ? 0 : getIdNoCsn().hashCode());
        result = prime * result + ((getIdNoCsv() == null) ? 0 : getIdNoCsv().hashCode());
        result = prime * result + ((getIdNoDn() == null) ? 0 : getIdNoDn().hashCode());
        result = prime * result + ((getMedicareCs() == null) ? 0 : getMedicareCs().hashCode());
        result = prime * result + ((getMedicareCsn() == null) ? 0 : getMedicareCsn().hashCode());
        result = prime * result + ((getMedicareCsv() == null) ? 0 : getMedicareCsv().hashCode());
        result = prime * result + ((getMedicareDn() == null) ? 0 : getMedicareDn().hashCode());
        result = prime * result + ((getNhCard() == null) ? 0 : getNhCard().hashCode());
        result = prime * result + ((getSscid() == null) ? 0 : getSscid().hashCode());
        result = prime * result + ((getCardOccuTypeCs() == null) ? 0 : getCardOccuTypeCs().hashCode());
        result = prime * result + ((getCardOccuTypeCsn() == null) ? 0 : getCardOccuTypeCsn().hashCode());
        result = prime * result + ((getCardOccuTypeCsv() == null) ? 0 : getCardOccuTypeCsv().hashCode());
        result = prime * result + ((getCardOccuTypeDn() == null) ? 0 : getCardOccuTypeDn().hashCode());
        result = prime * result + ((getCardNationCs() == null) ? 0 : getCardNationCs().hashCode());
        result = prime * result + ((getCardNationCsn() == null) ? 0 : getCardNationCsn().hashCode());
        result = prime * result + ((getCardNationCsv() == null) ? 0 : getCardNationCsv().hashCode());
        result = prime * result + ((getCardNationDn() == null) ? 0 : getCardNationDn().hashCode());
        result = prime * result + ((getNationalityCs() == null) ? 0 : getNationalityCs().hashCode());
        result = prime * result + ((getNationalityCsn() == null) ? 0 : getNationalityCsn().hashCode());
        result = prime * result + ((getNationalityCsv() == null) ? 0 : getNationalityCsv().hashCode());
        result = prime * result + ((getNationalityDn() == null) ? 0 : getNationalityDn().hashCode());
        result = prime * result + ((getArCs() == null) ? 0 : getArCs().hashCode());
        result = prime * result + ((getArCsn() == null) ? 0 : getArCsn().hashCode());
        result = prime * result + ((getArCsv() == null) ? 0 : getArCsv().hashCode());
        result = prime * result + ((getArDn() == null) ? 0 : getArDn().hashCode());
        result = prime * result + ((getAdCs() == null) ? 0 : getAdCs().hashCode());
        result = prime * result + ((getAdCsn() == null) ? 0 : getAdCsn().hashCode());
        result = prime * result + ((getAdCsv() == null) ? 0 : getAdCsv().hashCode());
        result = prime * result + ((getAdDn() == null) ? 0 : getAdDn().hashCode());
        result = prime * result + ((getTelTypeCs() == null) ? 0 : getTelTypeCs().hashCode());
        result = prime * result + ((getTelTypeCsn() == null) ? 0 : getTelTypeCsn().hashCode());
        result = prime * result + ((getTelTypeCsv() == null) ? 0 : getTelTypeCsv().hashCode());
        result = prime * result + ((getTelTypeDn() == null) ? 0 : getTelTypeDn().hashCode());
        result = prime * result + ((getLinkmanRelCs() == null) ? 0 : getLinkmanRelCs().hashCode());
        result = prime * result + ((getLinkmanRelCsn() == null) ? 0 : getLinkmanRelCsn().hashCode());
        result = prime * result + ((getLinkmanRelCsv() == null) ? 0 : getLinkmanRelCsv().hashCode());
        result = prime * result + ((getLinkmanRelDn() == null) ? 0 : getLinkmanRelDn().hashCode());
        result = prime * result + ((getLmIdNoCs() == null) ? 0 : getLmIdNoCs().hashCode());
        result = prime * result + ((getLmIdNoCsn() == null) ? 0 : getLmIdNoCsn().hashCode());
        result = prime * result + ((getLmIdNoCsv() == null) ? 0 : getLmIdNoCsv().hashCode());
        result = prime * result + ((getLmIdNoDn() == null) ? 0 : getLmIdNoDn().hashCode());
        result = prime * result + ((getAboCs() == null) ? 0 : getAboCs().hashCode());
        result = prime * result + ((getAboCsn() == null) ? 0 : getAboCsn().hashCode());
        result = prime * result + ((getAboCsv() == null) ? 0 : getAboCsv().hashCode());
        result = prime * result + ((getAboDn() == null) ? 0 : getAboDn().hashCode());
        result = prime * result + ((getRhCs() == null) ? 0 : getRhCs().hashCode());
        result = prime * result + ((getRhCsn() == null) ? 0 : getRhCsn().hashCode());
        result = prime * result + ((getRhCsv() == null) ? 0 : getRhCsv().hashCode());
        result = prime * result + ((getRhDn() == null) ? 0 : getRhDn().hashCode());
        result = prime * result + ((getCardEdBgCs() == null) ? 0 : getCardEdBgCs().hashCode());
        result = prime * result + ((getCardEdBgCsn() == null) ? 0 : getCardEdBgCsn().hashCode());
        result = prime * result + ((getCardEdBgCsv() == null) ? 0 : getCardEdBgCsv().hashCode());
        result = prime * result + ((getCardEdBgDn() == null) ? 0 : getCardEdBgDn().hashCode());
        result = prime * result + ((getBirthPlaceCs() == null) ? 0 : getBirthPlaceCs().hashCode());
        result = prime * result + ((getBirthPlaceCsn() == null) ? 0 : getBirthPlaceCsn().hashCode());
        result = prime * result + ((getBirthPlaceCsv() == null) ? 0 : getBirthPlaceCsv().hashCode());
        result = prime * result + ((getBirthPlaceDn() == null) ? 0 : getBirthPlaceDn().hashCode());
        result = prime * result + ((getNativeProvince() == null) ? 0 : getNativeProvince().hashCode());
        result = prime * result + ((getNativeProvinceCs() == null) ? 0 : getNativeProvinceCs().hashCode());
        result = prime * result + ((getNativeProvinceCsn() == null) ? 0 : getNativeProvinceCsn().hashCode());
        result = prime * result + ((getNativeProvinceCsv() == null) ? 0 : getNativeProvinceCsv().hashCode());
        result = prime * result + ((getNativeProvinceDn() == null) ? 0 : getNativeProvinceDn().hashCode());
        result = prime * result + ((getNativeCity() == null) ? 0 : getNativeCity().hashCode());
        result = prime * result + ((getNativeCityCs() == null) ? 0 : getNativeCityCs().hashCode());
        result = prime * result + ((getNativeCityCsn() == null) ? 0 : getNativeCityCsn().hashCode());
        result = prime * result + ((getNativeCityCsv() == null) ? 0 : getNativeCityCsv().hashCode());
        result = prime * result + ((getNativeCityDn() == null) ? 0 : getNativeCityDn().hashCode());
        result = prime * result + ((getVeteransMilitaryValue() == null) ? 0 : getVeteransMilitaryValue().hashCode());
        result = prime * result + ((getVeteransMilitaryMarkCs() == null) ? 0 : getVeteransMilitaryMarkCs().hashCode());
        result = prime * result + ((getVeteransMilitaryMarkCsn() == null) ? 0 : getVeteransMilitaryMarkCsn().hashCode());
        result = prime * result + ((getVeteransMilitaryMarkCsv() == null) ? 0 : getVeteransMilitaryMarkCsv().hashCode());
        result = prime * result + ((getCardCs() == null) ? 0 : getCardCs().hashCode());
        result = prime * result + ((getCardCsn() == null) ? 0 : getCardCsn().hashCode());
        result = prime * result + ((getCardCsv() == null) ? 0 : getCardCsv().hashCode());
        result = prime * result + ((getCardDn() == null) ? 0 : getCardDn().hashCode());
        result = prime * result + ((getCardAreaCs() == null) ? 0 : getCardAreaCs().hashCode());
        result = prime * result + ((getCardAreaCsn() == null) ? 0 : getCardAreaCsn().hashCode());
        result = prime * result + ((getCardAreaCsv() == null) ? 0 : getCardAreaCsv().hashCode());
        result = prime * result + ((getCardAreaDn() == null) ? 0 : getCardAreaDn().hashCode());
        result = prime * result + ((getPatientTypeValue() == null) ? 0 : getPatientTypeValue().hashCode());
        result = prime * result + ((getPatientTypeCs() == null) ? 0 : getPatientTypeCs().hashCode());
        result = prime * result + ((getPatientTypeCsn() == null) ? 0 : getPatientTypeCsn().hashCode());
        result = prime * result + ((getPatientTypeCsv() == null) ? 0 : getPatientTypeCsv().hashCode());
        result = prime * result + ((getPatientTypeDescr() == null) ? 0 : getPatientTypeDescr().hashCode());
        result = prime * result + ((getWorkingTelNo() == null) ? 0 : getWorkingTelNo().hashCode());
        result = prime * result + ((getMedicalTreatmentCs() == null) ? 0 : getMedicalTreatmentCs().hashCode());
        result = prime * result + ((getMedicalTreatmentCsn() == null) ? 0 : getMedicalTreatmentCsn().hashCode());
        result = prime * result + ((getMedicalTreatmentCsv() == null) ? 0 : getMedicalTreatmentCsv().hashCode());
        result = prime * result + ((getVersionNum() == null) ? 0 : getVersionNum().hashCode());
        result = prime * result + ((getResponsDocCode() == null) ? 0 : getResponsDocCode().hashCode());
        result = prime * result + ((getResponsDocName() == null) ? 0 : getResponsDocName().hashCode());
        result = prime * result + ((getOtherOcccDescr() == null) ? 0 : getOtherOcccDescr().hashCode());
        result = prime * result + ((getUsualTypeMark() == null) ? 0 : getUsualTypeMark().hashCode());
        result = prime * result + ((getSrcLevel() == null) ? 0 : getSrcLevel().hashCode());
        result = prime * result + ((getRelationPk() == null) ? 0 : getRelationPk().hashCode());
        ...
        result = prime * result + ((getBackups() == null) ? 0 : getBackups().hashCode());
        ...
        result = prime * result + ((getDrugAllergyMark() == null) ? 0 : getDrugAllergyMark().hashCode());
        result = prime * result + ((getOpHistoryMark() == null) ? 0 : getOpHistoryMark().hashCode());
        result = prime * result + ((getTraumaHistoryMark() == null) ? 0 : getTraumaHistoryMark().hashCode());
        result = prime * result + ((getBloodTransfMark() == null) ? 0 : getBloodTransfMark().hashCode());
        result = prime * result + ((getDisabilityMark() == null) ? 0 : getDisabilityMark().hashCode());
        result = prime * result + ((getGeneticDiseaseHistory() == null) ? 0 : getGeneticDiseaseHistory().hashCode());
        result = prime * result + ((getExhaustFacilityMark() == null) ? 0 : getExhaustFacilityMark().hashCode());
        result = prime * result + ((getExhaustFacilityTypeCode() == null) ? 0 : getExhaustFacilityTypeCode().hashCode());
        result = prime * result + ((getFuelTypeCode() == null) ? 0 : getFuelTypeCode().hashCode());
        result = prime * result + ((getWaterTypeCode() == null) ? 0 : getWaterTypeCode().hashCode());
        result = prime * result + ((getToiletTypeCode() == null) ? 0 : getToiletTypeCode().hashCode());
        result = prime * result + ((getLivestockPenTypeCode() == null) ? 0 : getLivestockPenTypeCode().hashCode());
        result = prime * result + ((getOperationHistory() == null) ? 0 : getOperationHistory().hashCode());
        result = prime * result + ((getAsthmaMark() == null) ? 0 : getAsthmaMark().hashCode());
        result = prime * result + ((getHedrtDisMark() == null) ? 0 : getHedrtDisMark().hashCode());
        result = prime * result + ((getCardiovascularCode() == null) ? 0 : getCardiovascularCode().hashCode());
        result = prime * result + ((getEpilepsyMark() == null) ? 0 : getEpilepsyMark().hashCode());
        result = prime * result + ((getCoagulopathyMark() == null) ? 0 : getCoagulopathyMark().hashCode());
        result = prime * result + ((getDiabetesMark() == null) ? 0 : getDiabetesMark().hashCode());
        result = prime * result + ((getGlaucomaMark() == null) ? 0 : getGlaucomaMark().hashCode());
        result = prime * result + ((getDialysisMark() == null) ? 0 : getDialysisMark().hashCode());
        result = prime * result + ((getOrganTransMark() == null) ? 0 : getOrganTransMark().hashCode());
        result = prime * result + ((getOrganDefectMark() == null) ? 0 : getOrganDefectMark().hashCode());
        result = prime * result + ((getRemovaProMark() == null) ? 0 : getRemovaProMark().hashCode());
        result = prime * result + ((getCardiacPacMark() == null) ? 0 : getCardiacPacMark().hashCode());
        result = prime * result + ((getOrtherMedicalAlert() == null) ? 0 : getOrtherMedicalAlert().hashCode());
        result = prime * result + ((getPsychiatricMark() == null) ? 0 : getPsychiatricMark().hashCode());
        result = prime * result + ((getFlag() == null) ? 0 : getFlag().hashCode());
        result = prime * result + ((getFlagGa() == null) ? 0 : getFlagGa().hashCode());
        result = prime * result + ((getDtUpdateGa() == null) ? 0 : getDtUpdateGa().hashCode());
        return result;
    }
}