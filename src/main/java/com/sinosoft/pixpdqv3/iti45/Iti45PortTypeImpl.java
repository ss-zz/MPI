...
public class Iti45PortTypeImpl implements Iti45PortType {
	...
	public String getIdentifiers(
			@WebParam(partName = "Body", name = "PRPA_IN201309UV02", targetNamespace = "urn:hl7-org:v3") String request) {
		Map<String, Object> ctx = new TreeMap<String, Object>();
		String result = null;
		// 解析xml 生成PersonInfo对象
		try {
			PersonInfoSimple p = cdaParser.parser(request, ICdaParser.CdaType.PRPA_IN201309UV02,
					PersonInfoSimple.class);
			// 放置查询参数
			ctx.put("ps", p);
			// 取得人员索引
