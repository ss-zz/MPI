...
/**
 * 只实现 operation 方法
 * continuation 和 cancel 涉及到有状态查询 暂不实现
 */
public class Iti47PortTypeImpl implements Iti47PortType {
    ...
    @Override
    public String operation(@WebParam(partName = "Body", name = "PRPA_IN201305UV02", targetNamespace = "urn:hl7-org:v3") String request) {
    ...
    @Override
    public String continuation(@WebParam(partName = "Body", name = "QUQI_IN000003UV01", targetNamespace = "urn:hl7-org:v3") String request) {
        return null;  //To change body of implemented methods use File | Settings | File Templates.
    }

    @Override
    public String cancel(@WebParam(partName = "Body", name = "QUQI_IN000003UV01_Cancel", targetNamespace = "urn:hl7-org:v3") String request) {
        return null;  //To change body of implemented methods use File | Settings | File Templates.
    }
}
