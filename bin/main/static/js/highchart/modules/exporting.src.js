...
var HC = Highcharts,
	...
	extend(defaultOptions.lang, {
		downloadPNG: '下载为 PNG格式的图片',
		downloadJPEG: '下载为 JPEG格式的图片',
		/*downloadPDF: '下载为 PDF格式的图片',
		downloadSVG: '下载为 SVG格式的图片',*/
		exportButtonTitle: '导出为矢量图像',
...
defaultOptions.exporting = {
	...
	filename: 'chart',
	type: 'image/png',
	url: '/mpi/getHighchartServlet.ac',
	width: 800,
	buttons: {
		exportButton: {
			//enabled: true,
